...
import com.SrinidhiBoardMeeting.Repo.UserDepartMapRepository;
import com.SrinidhiBoardMeeting.Service.UserDeptMapService;
...
public class UserDeptMapController {
	...
	@PostMapping("/create")
	public ResponseEntity<List<UserDeptMap>> createUserDeptMap(@RequestBody UserDeptMap request) {
