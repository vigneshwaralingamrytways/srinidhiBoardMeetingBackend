...
import com.SrinidhiBoardMeeting.Service.PasswordResetService;
import com.SrinidhiBoardMeeting.exception.UserNotFoundException;
import com.SrinidhiBoardMeeting.helper.RandomPasswordGenerator;
...
public class PasswordResetController {
	...
	public void sendEmailWithPassword(String recipientEmail, String updatedPassword)
		...
		String content = "<p>Hello,</p>" + "<p>You have requested to use the new password for SRIPATHI Application.</p>"
				+ "<p>" + updatedPassword + "</p>" + "<br>" + "<p>Ignore this email if you do remember your password, "
...
//	public ResponseEntity<String> requestPasswordResetForClient(@RequestBody Map<String, String> requestBody,
//			HttpServletRequest request) {
//
//		String userName = requestBody.get("userName");
//		int passwordLength = 10; // Adjust the length as needed
