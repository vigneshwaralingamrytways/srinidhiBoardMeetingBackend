...
import com.SrinidhiBoardMeeting.Categories.ActiveStatus;
import com.SrinidhiBoardMeeting.Categories.ActiveStatusConvertor;
...
public class UserDeptMap extends BaseEntity {
	...
	// @NotBlank(message="Process Name must not be blank")
	// @Size(min=3,max=100, message="Customer Name must be between 3 to 100
	// characters")
